        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <div className="relative">
              ...
              {showNotifications && (
                <div className="absolute right-0 mt-2 w-84 bg-white rounded-xl shadow-2xl border border-slate-200 text-slate-800 py-2 z-50 animate-in fade-in slide-in-from-top-2 duration-150">
                  <div className="px-4 py-2 border-b border-slate-100 flex items-center justify-between">
                    <div className="flex items-center gap-1.5">
                      <span className="text-xs font-bold uppercase tracking-wider text-slate-700">
                        Notifications
                      </span>
                      <span className="px-1.5 py-0.2 rounded text-[9px] font-bold bg-amber-500/20 text-amber-700 uppercase">
                        Live Push
                      </span>
                    </div>
                    <div className="flex items-center gap-2">
                  ...
                  {/* Real-time push reminder quick bar */}
                  {onTriggerTestPush && (
                    <div className="px-3 py-1.5 bg-amber-50/70 border-b border-amber-100 flex items-center justify-between">
                      ...
                      <button
                        ...
                        className="px-2 py-0.5 bg-amber-500 hover:bg-amber-600 text-slate-950 font-black text-[10px] rounded flex items-center gap-1 transition-all"
                      >
